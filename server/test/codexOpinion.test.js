...
test('codexOpinionMeta : signale un avis produit avec un ancien modele', () => {
  ...
  assert.deepEqual(codexOpinionMeta({ model_version: 'codex-book-v93' }), {
    current_model_version: CURRENT_CODEX_MODEL_VERSION,
    opinion_model_version: 'codex-book-v93',
    is_current: false,
    needs_recalculation: true,
  });
});
