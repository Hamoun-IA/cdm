...
export const CURRENT_CODEX_MODEL_VERSION = 'codex-book-v3';
...
export function codexOpinionMeta(opinion) {
  ...
  return {
    ...
    is_current: opinionModelVersion === CURRENT_CODEX_MODEL_VERSION,
    needs_recalculation: opinionModelVersion !== CURRENT_CODEX_MODEL_VERSION,
  };
}
